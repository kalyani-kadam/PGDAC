...
public class CmsValidations {
	...
	public static Customer validateInputs(String firstName, String lastName, String email, String password,String dob, double registrationAmount, String plan, List<Customer> arr ) throws CustomerException {

		LocalDate birthdate=validateDate(dob);
		checkDupEmail(email,arr);  //here email is validating
...
//	(i.e if the customer tries to register using existing email , raise custom exception)
	...
	public static void checkDupEmail(String email, List<Customer> arr) throws CustomerException {
...
//			if(c!=null && c.getEmail().equals(email))
		//all above code is not required as you are using List
		
			if(arr.contains(cust)) {

...
// add public static method to validateb all i/ps

public static BankAccount validateInputs(int acctNo, String firstName,String lastName,  
		String acType, String dob, String creationDate, double balance)throws BankingException {
...
//	return null;
	return new BankAccount(acctNo,firstName, creationDate, type, crDate, crDate, balance);
}
}

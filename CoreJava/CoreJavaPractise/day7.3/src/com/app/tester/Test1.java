...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		Employee e8=new Employee("AAAA", "a7 b7", 10000);
		Employee e9=new Employee("kalyani", "a7 b7", 10000);
		...
		//just for confirmation
				System.out.println("BBBB".hashCode()+" "+"AaBB".hashCode()+" "+"AAAA".hashCode()+"  "+"kalyani".hashCode());

				...
				try {
					...
					switch(sc.nextInt()) {
						...
						case 1:
							...
							Employee emp = addFullTimeEmp(sc.next(),sc.next(),sc.next(),sc.next(),sc.nextDouble(),emps);
//							emps.putIfAbsent(emp.getAadhaarNumber(), emp);
							emps.put(emp.getEmpId(), emp);
							System.out.println("Emp added");
							break;
							
//							hk 2023-01-11 1234567890 123456789012 79000
//							mk 2002-11-21 1234567890 123456789012 49000
						...
						case 2:
							...
							System.out.println("enter part time emp details -  Name, DateOfJoining, PhoneNumber, AadhaarNumber");
							Employee emp1 = addPartTimeEmp(sc.next(),sc.next(),sc.next(),sc.next(),salarysum,emps);
//							emps.putIfAbsent(emp.getAadhaarNumber(), emp);
							emps.put(emp1.getEmpId(), emp1);
							System.out.println("Emp added");
							break;
//							kalyani 2023-02-02 7893209327 280973288888
//							nk 2001-12-11 7894567890 1234567890144
						case 3:

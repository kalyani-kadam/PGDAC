...
public class Utils {
	public static Employee addFullTimeEmp(String name, String dateOfJoining, String phoneNumber, String aadhaarNumber,
			double salary, Map<Integer, Employee> emps) throws EmployeeException {
...
//		int adhNo = Integer.parseInt(aadhaarNumber);
	...
	public static Employee addPartTimeEmp(String name, String dateOfJoining, String phoneNumber, String aadhaarNumber,
			double salary, Map<Integer, Employee> emps) throws EmployeeException {
		LocalDate Doj = LocalDate.parse(dateOfJoining);
...
//		System.out.println("Enter hourly salary:");
	...
	public static void checkForDup(String adhNo, Map<Integer, Employee> emps) throws EmployeeException {
		...
		for (Employee e : emps.values()) {
			if (e.getAadhaarNumber().equals(adhNo)){
				throw new EmployeeException("duplicate adhaar no");
			}
		}
		System.out.println("in check method " + emps.containsKey(adhNo));
	}

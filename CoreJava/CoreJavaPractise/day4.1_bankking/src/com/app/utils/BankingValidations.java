...
//	public static BankAccount searchAccount(int acctNo,BankAccount[] accts)throws BankingException{
	public static BankAccount searchAccount(int acctNo,BankAccount[] accts)throws BankingException{
		BankAccount acct=new BankAccount(acctNo);
		System.out.println(acct);
		for (BankAccount a : accts) {
			if(a != null && a.equals(acct)) 
//				System.out.println("AcctNO exist");
//				return acctNo;
				return a;	
		}
		throw new BankingException("Account not exist...!");
//		return acctNo;
//		return acct;
	}
	
//	public static BankAccount withdrawbyAcctNo(int acctNo,BankAccount[] accts)throws BankingException{
//		searchAccount(acctNo, accts);
//		
//		return null;
//		
//	}

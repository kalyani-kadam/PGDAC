			...
			while (!exit) {
				...
				try {
					...
					case 8:// sort acct details as per asc order of acct nos (Natural Ordering)
						...
						break;
					case 9:
						// sort acct details as per asc order of bal (Custom ordering)
						...
						Collections.sort(list, new BankAccountBalanceComparator());
						System.out.println("sorted accts as per balance");
						for(BankAccount a : list)
							System.out.println(a);
						break;
					case 10: // sort acct details as per asc order of dob
//						Collections.sort(accounts, new BankAccountDobComparator(accounts.values()));
						break;
					case 11: // sort acct details as per asc order of dob n balance(desc)
//						Collections.sort(accounts, new BankAccountDobBalanceComparator(accounts.values()));
						break;

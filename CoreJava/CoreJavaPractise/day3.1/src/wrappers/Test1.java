...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		Float f=Float.valueOf(12.36F); //boxing -->adding float value in to Float 
		float fl=f.floatValue(); //extract --> un boxing
		System.out.println(fl);
		f++;
		fl=1273.638f; //auto boxing
		System.out.println(fl);
		fl++; //auto unboxing --> inc -->auto boxing
		System.out.println(fl);
		
		Double d= Double.valueOf(12.8209F);
...
//		d++;
		...
		String s="123456";
	//s++; //type mismatch from string to int
	//	s++; javac err
		Date d1=new Date();
	//	d1++;//javac err
...
//		float f12=123.673f;
//		f12=6728.82; //cant convert float to double
		
		float f13 = (float)d2; //narrowing
